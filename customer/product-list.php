              ...
              html += `
                <div class="col-md-6 col-lg-4 mb-4">
                  <div class="card h-100 shadow-sm">
                    <img src="../${product.first_image || 'placeholder.jpg'}" class="card-img-top" alt="${product.product_name}" style="height: 200px; object-fit: cover;">
                    <div class="card-body d-flex flex-column">
                      <h5 class="card-title">${product.product_name}</h5>
                      <p class="card-text mb-1">Quantity: ${product.quantity}</p>
                      <p class="card-text text-primary fw-bold">₱${parseFloat(product.selling_price).toFixed(2)}</p>
                      <button class="btn btn-primary mt-auto" onclick="viewProductDetails(${product.product_id})">View Details</button>
                    </div>
                  </div>
                </div>
              `;
