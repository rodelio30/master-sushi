  ...
  .card-body p {
    ...
    <div class="py-4">
      ...
      <div class="px-14 text-sm text-neutral-700">
        <p>Mode of Payment: <span class="text-main font-bold"><?= htmlspecialchars($order['payment_method']) ?></span> </p>
      </div>
    </div>
    <div class="px-14 d-md-flex justify-content-md-between">
      <a href="order_details.php?order_id=<?= $order_id ?>" class="btn btn-secondary btn-sm no-print">Back</a>
