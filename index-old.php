...
$stmt_ip = $conn->prepare("INSERT INTO user_logs (ip_address, access_time, user_agent, country, region, city) VALUES (?, ?, ?, ?, ?, ?)");
$stmt_ip->bind_param("ssssss", $ip, $timestamp, $user_agent, $country, $region, $city);
$stmt_ip->execute();
$stmt_ip->close();
...
<section id="productSectionPublic" style="padding: 20px;">
  <br> <br>
  <div class="container">
  <div class="row mt-4">
